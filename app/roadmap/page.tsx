...
export const metadata: Metadata = {
  title: "Roadmap",
  description:
    "Interactive learning roadmaps — a high-level prerequisite graph across Mathematics, Physics, Computer Science, Artificial Intelligence, and Quantitative Finance, with live progress.",
