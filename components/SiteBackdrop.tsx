 ...
 * parallax, and a page-wide twinkling starfield. Theme images/sparkle colors come from CSS
 * variables (swapped pre-paint). Under `prefers-reduced-motion` the overlay is static and the
